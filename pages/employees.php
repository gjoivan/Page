<div class="row">
    <div class="col-md-10">
        ...
        <div class="row">
            ...
            <div class="col-xs-2"  >
                <a style="float: right;" class="btn btn-sm btn-primary" style="margin-top:8px;" target="_blank" onclick="create_edit_employee_modal();">Create employee</a>
            </div>
            <div class="col-xs-2">
                <a style="float: right;" class="btn btn-sm btn-primary" style="margin-top:8px;" target="_blank" href="/bo/ajax/clients_ajax.php?e=export_verified_clients">Export Employees</a>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
